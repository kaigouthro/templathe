...
```python
from langchain.tools.google\_scholar import GoogleScholarQueryRun  
from langchain.utilities.google\_scholar import GoogleScholarAPIWrapper  
import os  

```

```python
os.environ["SERP\_API\_KEY"] = ""  
tool = GoogleScholarQueryRun(api\_wrapper=GoogleScholarAPIWrapper())  
tool.run("LLM Models")  
